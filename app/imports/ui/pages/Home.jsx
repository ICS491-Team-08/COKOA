...
const Center = () => {
  return (
    <div className="flex-center flex-column home-card">
      <Card className="virtual-id">
        <Card.Content className="profile-pic">
          <Image
            floated="left"
            size="small"
        ...
        <Card.Content className="id-contents">
          <Card.Header className="profile-header">
            Virtual ID : H12345678
          </Card.Header>
          <Card.Meta className="profile-header">
            Covid-19 Vaccination Record Card
          </Card.Meta>
          <br />
          <Card.Description>
            <Icon name="check circle outline" size="large" color="green" /> 1st
            Dose of Covid-19
          </Card.Description>
          <br />
          <Card.Description>
            <Icon name="check circle outline" size="large" color="green" /> 2nd
            Dose of Covid-19
          </Card.Description>
          <br />
          <Card.Description>
        ...
        <Card.Content extra style={{ width: "auto" }}>
