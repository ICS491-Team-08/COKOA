...
const genderOptions = [
  ...
  { key: 'male', text: 'Female', value: 'Female' },
];

const vaccineOptions = [
  { key: 'pfizer', text: 'Pfizer', value: 'Pfizer' },
  { key: 'moderna', text: 'Moderna', value: 'Moderna' },
  { key: 'janssen', text: 'Janssen', value: 'Janssen' },
  { key: 'no', text: 'No vaccine', value: 'No vaccine' },
];
...
class Signup extends React.Component {
  ...
  constructor(props) {
    super(props);
    this.state = { email: '', password: '', firstName: '', lastName: '', gender: '', vaccine: '', error: '', redirectToReferer: false };
  }
